...
OPERATOR_STRINGS: dict[str, dict[str, str]] = {
    "en": {
        ...
        "inv_hte_gate_note": "Method: {method} · holdout n: {n}. A cell is called validated only when its validation_ref passes both the AUUC and calibration gates.",
    ...
    "zh": {
        ...
        "inv_hte_gate_note": "验证方式：{method}·holdout 样本量：{n}。只有 validation_ref 同时过 AUUC 与校准两道门槛的格子，才配叫'验证过'。",
